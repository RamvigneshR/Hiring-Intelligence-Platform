...
A data engineering pipeline that ingests live job postings from the 
Arbeitnow API,transforms the raw data and loads structured records into a PostgreSQL star schema - ready for analytics and AI.
...
Orchestration  Airflow (To be scaled to)           
Cloud          Azure (To be scaled to)             
Scale          PySpark (To be scaled to)           
Transforms     dbt (To be scaled to)               
...
Dimension Tables
    ...
    dim.dim_date - full date records from 2020 to 2100
...
Step 4 - Clean and enrich data into stage.stage_jobs:
